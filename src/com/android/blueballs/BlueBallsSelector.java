...
public class BlueBallsSelector extends Activity implements
        CompoundButton.OnCheckedChangeListener, SeekBar.OnSeekBarChangeListener {
    private static final String LOG_TAG = "BlueBallsSelector";

    public static final String KEY_PREFS = "blueballs";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWallpaperIntent = new Intent(this, BlueBallsWallpaper.class);
